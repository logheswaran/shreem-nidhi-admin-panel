...
const Sidebar = () => {
  ...
  return (
    <aside className="h-screen w-64 fixed left-0 top-0 border-r border-brand-gold/10 bg-surface-container shadow-xl flex flex-col z-50 transition-all duration-300">
      ...
      <div className="bg-brand-gold/5 border-t border-brand-gold/10 p-4">
        <div className="flex items-center gap-3 px-2 py-3">
          <div className="w-10 h-10 rounded-full border-2 border-brand-gold/40 flex items-center justify-center bg-white overflow-hidden shrink-0">
            {profile?.full_name ? (
          ...
          <div className="truncate flex-1">
            <p className="font-headline tracking-tight text-on-surface leading-tight font-bold truncate">
          ...
          <button 
            onClick={signOut}
            className="text-brand-text/40 hover:text-brand-gold transition-colors p-1"
            title="Log Out"
          >
