    ...
    { 
      ...
      render: (row) => (
        <button 
          ...
          className="flex items-center gap-2 px-4 py-2 bg-brand-gold/10 text-brand-goldDark text-[10px] font-black uppercase tracking-widest rounded-full hover:bg-brand-gold hover:text-white transition-all shadow-sm active:scale-95"
        >
          <ArrowUpRight className="w-3.5 h-3.5" /> View Profile
        </button>
      )
    }
  ]
