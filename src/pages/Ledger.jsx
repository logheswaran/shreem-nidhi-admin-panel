    ...
    <div className="animate-in fade-in duration-700">
      <header className="mb-10 flex flex-col md:flex-row justify-between items-start md:items-end gap-6">
        ...
        <div className="flex gap-4">
          <button className="bg-white px-8 py-3.5 rounded-full text-[10px] font-black uppercase tracking-widest text-brand-navy border border-brand-gold/10 hover:bg-brand-gold/5 transition-all shadow-xl flex items-center gap-3 active:scale-95">
